...
export default function NotFoundPage() {
  return (
    <main className="relative min-h-dvh flex flex-col items-center justify-center px-6 py-12 overflow-hidden bg-surface-base">
      ...
      <div className="relative z-content w-full max-w-md flex flex-col items-center gap-8 text-center">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <h1 className="font-display text-[28px] sm:text-[32px] font-medium leading-tight text-text-primary">
        ...
        <Link
          href="/comando"
          className="inline-flex items-center gap-2 min-h-11 h-11 px-6 rounded-input bg-accent-cta text-accent-cta-fg font-display uppercase tracking-[0.06em] text-[13px] font-medium hover:bg-accent-hover active:scale-[0.98] transition-all lift-hover"
        >
